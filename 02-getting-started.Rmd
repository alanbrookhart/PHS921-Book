...
R is the language; RStudio is the interactive development environment that most people use to write and run R program interactively. Appendix A walks through installing both, along with the packages
