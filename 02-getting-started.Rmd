...
R is the language and RStudio is the interactive development environment that most people use to write and run R program interactively. Appendix A walks through installing both, along with the packages
this book uses. Once they are installed, you will type or paste code
into a script or, as here, into a code chunk inside an R Markdown
document, and run it a line or a chunk at a time.

The basic vocabulary of R is fairly small. An **object** is a name that holds a
...
either a nonselective NSAID or a Cox-2 selective inhibitor, and allows us to examine how the choice of medication class affects the risk of incident peptic ulcer disease. `glimpse()` gives a quick sense of what is in it:
...
cohort the book uses to illustrate methods for time-to-event data.
...
Nearly every study of an observational cohort includes a table describing the
...
a reader first suspects that they may not be. Because some version of this
